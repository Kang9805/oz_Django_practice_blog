...
SECRET_KEY = 'django-insecure-_^dt85cqoit=(@5$ffu5se7(*ft7em=n^hu+en!$h0*1fwzuds'
...
# https://github.com/mozilla/bleach / https://github.com/lqez/django-summernote/blob/main/django_summernote/settings.py#L106-L133
